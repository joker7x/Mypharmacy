...
import { Badge, COLORS, PageHeader, ReferenceTopBar, RoundIcon } from "@/components/app-ui";
...
const styles = StyleSheet.create({
  ...
  countText: { color: COLORS.muted, fontSize: 11, fontWeight: "800", textAlign: "right", marginTop: 16, marginBottom: 9 },
  item: { flexDirection: "row-reverse", alignItems: "center", gap: 11, paddingVertical: 15, paddingHorizontal: 13, borderRadius: 24, marginBottom: 9 },
  itemAvailable: { backgroundColor: "#F2F1EE" },
  itemExpiry: { backgroundColor: COLORS.softWarning },
  itemLow: { backgroundColor: COLORS.softWarning },
  itemBody: { flex: 1, alignItems: "flex-end" },
  itemTop: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between", width: "100%" },
  itemName: { flex: 1, color: COLORS.ink, fontSize: 13, fontWeight: "900", textAlign: "right", paddingLeft: 7 },
  price: { color: COLORS.primary, fontSize: 12, fontWeight: "900", writingDirection: "ltr" },
  itemMeta: { flexDirection: "row-reverse", justifyContent: "space-between", width: "100%", marginTop: 4 },
  itemCategory: { flex: 1, color: COLORS.muted, fontSize: 10, textAlign: "right" },
  quantity: { color: COLORS.success, fontSize: 10, fontWeight: "900" },
  badges: { flexDirection: "row-reverse", gap: 6, marginTop: 7 },
  separator: { height: 0 },
