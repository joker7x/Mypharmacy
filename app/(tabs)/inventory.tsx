...
const styles = StyleSheet.create({
  ...
  searchBox: { height: 52, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, borderRadius: 14, flexDirection: "row-reverse", alignItems: "center", paddingHorizontal: 14, gap: 9 },
  ...
  filter: { borderWidth: 1, borderColor: COLORS.border, backgroundColor: COLORS.surface, borderRadius: 9, paddingHorizontal: 10, paddingVertical: 8 },
  ...
  item: { flexDirection: "row-reverse", alignItems: "center", gap: 11, paddingVertical: 14, backgroundColor: COLORS.background },
