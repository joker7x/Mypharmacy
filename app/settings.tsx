...
export default function SettingsScreen() {
  ...
  return <ScreenContainer className="flex-1"><ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
    ...
    <View style={styles.card}><ToolRow icon="▣" title="الطابعة وحافظة الملصقات" detail="USB مباشر، تصميم الملصق، والملصقات المعلقة" onPress={() => router.push("/tools")} />{can("staff.manage") ? <ToolRow icon="◉" title="لوحة المسؤول" detail="الأفراد والصلاحيات والجلسات وسجل النشاط" onPress={() => router.push("/staff-admin")} bordered /> : null}</View>
