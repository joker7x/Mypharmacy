...
export function Card({ children, style, glass = false }: { children: ReactNode; style?: ViewStyle; glass?: boolean }) { const content = <View style={styles.cardContent}>{children}</View>; return glass ? <BlurView intensity={22} tint="light" style={[styles.card, style]}>{content}</BlurView> : <View style={[styles.card, style]}>{children}</View>; }
...
export const commonStyles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: "rgba(23, 107, 104, 0.94)", borderColor: "rgba(255,255,255,0.28)", borderWidth: 1, borderRadius: 18, alignItems: "center", justifyContent: "center", minHeight: 56, paddingHorizontal: 20, flexDirection: "row-reverse", gap: 9, shadowColor: COLORS.primary, shadowOpacity: 0.16, shadowRadius: 14, shadowOffset: { width: 0, height: 7 }, elevation: 3 },
  primaryButtonText: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", textAlign: "center" },
  secondaryButton: { backgroundColor: "rgba(255,255,255,0.58)", borderColor: "rgba(255,255,255,0.82)", borderWidth: 1, borderRadius: 18, alignItems: "center", justifyContent: "center", minHeight: 54, paddingHorizontal: 20, flexDirection: "row-reverse", gap: 9 },
  secondaryButtonText: { color: COLORS.ink, fontSize: 15, fontWeight: "800", textAlign: "center" },
  input: { backgroundColor: "rgba(255,255,255,0.68)", borderWidth: 1, borderColor: "rgba(255,255,255,0.88)", borderRadius: 16, minHeight: 52, paddingHorizontal: 15, fontSize: 15, color: COLORS.ink, textAlign: "right", writingDirection: "rtl" },
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: "rgba(255,255,255,0.62)", borderWidth: 1, borderColor: "rgba(255,255,255,0.82)", borderRadius: 24, padding: 17, shadowColor: "#214B5C", shadowOpacity: 0.10, shadowRadius: 20, shadowOffset: { width: 0, height: 9 }, elevation: 3 }, sectionHeader: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between", marginTop: 30, marginBottom: 13 }, sectionTitle: { color: COLORS.ink, fontSize: 18, fontWeight: "900", textAlign: "right", letterSpacing: -0.2 }, sectionAction: { color: COLORS.primary, fontSize: 13, fontWeight: "800" },
  cardContent: { flex: 1 }, badge: { overflow: "hidden", borderRadius: 10, paddingHorizontal: 9, paddingVertical: 5, fontSize: 11, lineHeight: 14, fontWeight: "800", textAlign: "center" }, roundIcon: { width: 46, height: 46, borderRadius: 16, alignItems: "center", justifyContent: "center" },
});
