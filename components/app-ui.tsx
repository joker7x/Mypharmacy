...
export function Card({ children, style }: { children: ReactNode; style?: ViewStyle }) { return <BlurView intensity={34} tint="light" style={[styles.card, style]}>{children}</BlurView>; }
